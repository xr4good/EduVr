...
namespace SeriousGameComponents.AudioPlayerComponent
{
    ...
    public class AudioPlayerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.LabelField(new GUIContent("<b>General URL Download Options</b>","Interface to manage the downloading of audios from the URLs specified in the Audio Files array"), labelTitleStyle);
