...
namespace SeriousGameComponents
{
    namespace AudioPlayerComponent
    {
        ...
        public class AudioPlayer : MonoBehaviour
        {
            ...
            [Tooltip("Flag to tell if the assets that this component will use are being loaded from the XR4GOOD LMS with the LMSLoader component (WIP)")]
            [HideInInspector]
            ...
            {
                if(index >= audioFiles.Count || index < 0)
                {
                    throw new ArgumentOutOfRangeException("Invalid index for audio: " + index);
                }
            ...
            public void NextAudio()
            {
                ...
                ChangeCurrentAudioClip(currentAudioIndex+1);
            }
